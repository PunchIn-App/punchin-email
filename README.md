...
[![Version](https://img.shields.io/badge/version-1.3.1-1f6feb?style=flat)](docs/CHANGELOG.md)
...
| **Status** | Stable — v1.3.1. See [`docs/CHANGELOG.md`](docs/CHANGELOG.md) for history. |
